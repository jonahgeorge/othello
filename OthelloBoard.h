...
/**
 * This class is a specialized version of the Board class for Othello. The 
 * OthelloBoard class respects the rules of Othello and also keeps track of 
 * the symbols for Player 1 and Player 2.
 */
